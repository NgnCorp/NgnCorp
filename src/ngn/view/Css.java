...
public class Css extends Ngn {
    ...
    public static void MainFrame(JFrame MFrame, JPanel StatusBar, JPanel Ngn, JPanel Footer) {
        ...
        StatusBar.setMaximumSize(new Dimension(windowWidth, windowHeight/4));
        StatusBar.setPreferredSize(new Dimension(windowWidth, windowHeight/4));
        StatusBar.setLayout(new CardLayout());
        
        Ngn.setLayout(new CardLayout());
        
        Footer.setBackground(new Color(204, 0, 0));
        Footer.setMaximumSize(new Dimension(windowWidth, windowHeight/4));
        Footer.setPreferredSize(new Dimension(windowWidth, windowHeight/4));
